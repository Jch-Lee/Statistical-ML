...
* 전처리:
    ...
    * Aug2: Basic + RandomRotation -45~45 + RandomFlip(p=0.7) + ColorJitter(brightness=0.2, contrast=0.2, hue=0.2, saturation=0.2)ColorJitter(brightness=0.3, contrast=0.3)
